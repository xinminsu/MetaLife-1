...
export const HomeIcon = (style: ImageStyle): IconElement => (
    <Icon  pack='app' name='home' resizeMode='contain'/>
);

export const MessagesIcon = (style: ImageStyle): IconElement => (
    <Icon  pack='app' name='messages' resizeMode='contain'/>
);

export const ContactsIcon = (style: ImageStyle): IconElement => (
    <Icon  pack='app' name='contacts' resizeMode='contain'/>
);

export const DiscoverIcon = (style: ImageStyle): IconElement => (
    <Icon  pack='app' name='discover' resizeMode='contain'/>
);

export const ProfilesIcon = (style: ImageStyle): IconElement => (
    <Icon  pack='app' name='profiles' resizeMode='contain'/>
);
