# Contributing to MetaLife

We would love for you to contribute to MetaLife and help make it ever better together! :rocket:
...
Help us keep MetaLife open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `MetaLife`.
...
* If you have a question about using MetaLife, please ask on the [StackOverflow][stackoverflow].
...
we use the git commit messages to **generate the MetaLife change log**.
